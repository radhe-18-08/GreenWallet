...
.gw-card{{background:{CARD};border:1px solid {BORDER};border-radius:16px;padding:18px 20px;margin-bottom:14px;}}
.gw-accent{{border-left:3px solid {GREEN};}}
.brand-title{{font-size:26px;font-weight:700;color:{TEXT};letter-spacing:-0.5px;}}
.brand-title span{{color:{GREEN};}}
